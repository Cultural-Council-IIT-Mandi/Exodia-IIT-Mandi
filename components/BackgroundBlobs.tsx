...
const BackgroundBlobs = () => {
  ...
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden">
      ...
      <>
        <motion.div
        className="fixed w-[300px] h-[300px]  -translate-y-[45%] rounded-full bg-purple-500/25 blur-3xl animated-blob"
        animate={{
          scale: [1, 1.2, 1],
          rotate: [0, 180, 0],
        }}
      ...
      <motion.div
        className="fixed w-[200px] h-[200px] left-1/2 top-1/2 -translate-x-[50%] -translate-y-[45%] rounded-full bg-purple-700/25 blur-3xl animated-blob"
        animate={{
          scale: [1, 1.2, 1],
          rotate: [0, 180, 0],
        }}
